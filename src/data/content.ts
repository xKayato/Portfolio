...
export const projects = [
  ...
  },
  {
    ...
    images: ["/placeholder.svg"],
    link: "#",
    detailedDescription: "Au cours de ma formation, j’ai réalisé plusieurs travaux pratiques en cybersécurité, me permettant d'acquérir des compétences essentielles en sécurité informatique et en test d’intrusion. Ces TP m’ont appris à rédiger un rapport de pentest et une annexe explicative, utiliser des outils d’analyse comme Nmap, SQLMap, BurpSuite, Metasploit et Nessus, mettre en place un pivot SSH, rechercher et exploiter des failles, et examiner un malware. Ces expériences m’ont permis d’approfondir mes compétences techniques en cybersécurité, d’améliorer ma méthodologie d’audit et de développer une approche rigoureuse dans l’analyse des vulnérabilités et la rédaction de rapports professionnels."
  },
  {
    title: "Projet FluxMedia : Étude de fichier audio",
